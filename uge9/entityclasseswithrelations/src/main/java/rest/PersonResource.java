...
public class PersonResource {
    ...
    public Response addPerson(String person)throws MissingInputException {
        ...
        pDTO = FACADE.addPerson(pDTO.getfName(), pDTO.getlName(), pDTO.getPhone(),
                new Address(pDTO.getCity(), pDTO.getZip(), pDTO.getStreet()));
    ...
    public String populateDB() throws MissingInputException {
        FACADE.addPerson("Allan", "Simonsen", "34567890", new Address("Nexo", "3730", "Stormgade 11"));
        FACADE.addPerson("Niels", "Simonsen", "34567890", new Address("Nexo", "3730", "Stormgade 11"));
        FACADE.addPerson("Pia", "Simonsen", "34567890", new Address("Nexo", "3730", "Stormgade 11"));
